...
public class SettlementServiceImpl implements SettlementService {
    ...
    public void processPayment(String ciphertext) throws Exception {
        ...
        String hash = hybridCryptoService.hashCiphertext(ciphertext);

        if(transactionRepository.findByPacketHash(hash).isPresent()) {
            throw new RuntimeException("Packet already processed");
        }
